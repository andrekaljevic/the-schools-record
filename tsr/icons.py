"""Inline icon set (lucide) as published by the front-end bundle."""
...
ICONS: dict[str, str] = {
    'arrow_down_to_line': (
        '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-down-to-line" aria-hidden="true"><path d="M12 17V3"></path><path d="m6 11 6 6 6-6"></path><path d="M19 21H5"></path></svg>'
    ),
    'arrow_right': (
...
def icon(name: str, extra_class: str = "") -> str:
    ...
    if extra_class:
        markup = markup.replace(
            'class="lucide lucide-', f'class="{extra_class} lucide lucide-', 1
        )
    return markup
